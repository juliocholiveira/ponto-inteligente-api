...
import com.jcho.pontointeligente.api.repositories.EmpresaRepository;
...
public class EmpresaServiceTest {
	...
	/* Pacote do Mockito que cria instâncias falsas de classes
	 * */
	@MockBean
	...
	public void setUp() throws Exception {
		...
		/* Define os metodos que serão chamados. O mockito cria objetos falsos, ou seja, para método A retorne B */
